...
class WeiBo:
    def __init__(self):
        self.bili = BiliBili(SESSDATA="90e9a97d%2C1674057794%2Cf5956%2A71",
                             bili_jct="974dd635d11e63b540f23bd8a90ba4c1", DedeUserID="480045762")
        self.weibo_session = requests.session()
        # 微博主要分类
        self.WeiBo_video_classify = ['搞笑', '恶搞', '沙雕', '生活', '日常', '幽默', '美食', '萌宠']
        self.headers = {
            'User-Agent':
